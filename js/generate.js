        ...
        for (let i = 0; i <noofcard.value ; i++) {
            ...
            if(showsimname.innerText == "MTN") {
                ...
                <button class="float-right btn okay" onclick='vouchokay()'>Okay</button>`
                    ...
                    alert2.style.display = "block";
                    alertmessage.innerHTML = `<div class="enteroption small">You have successfully generated ${noofcard.value} &#8358;${amount.value} Glo Card. Press "Show card" button to View and copy generated Card. Dial *123*PIN# to load card</div>
                    <button class="float-right btn okay" onclick='vouchokay()'>Okay</button>`
